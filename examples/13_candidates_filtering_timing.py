...
filtering, not indexing engine: for all three TextIndex backends -- this
...
metadata pre-filter, not itself a TextIndex), reused for all three backends:
...
from simlar import BM25CIndex, LookupIndex, RelevanceIndex
...
def main() -> None:
    ...
    print(
        f"Build: bm25c={bm25c_build_ms:.0f}ms "
